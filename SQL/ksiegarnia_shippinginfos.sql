...
DROP TABLE IF EXISTS `shippinginfos`;
...
LOCK TABLES `shippinginfos` WRITE;
/*!40000 ALTER TABLE `shippinginfos` DISABLE KEYS */;
/*!40000 ALTER TABLE `shippinginfos` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-12-07 23:57:59
